...
// Verbatim from Jenny's published client-testimonial graphics (5★ each). Do not edit clients' words.
const TESTIMONIALS=[
 {name:"Amee P.",role:"",c:"#b0447e",t:`Jenny is one of our favorite humans on the planet.  I say this with the most sincerity, not just because her responsiveness was pivotal  in helping us find our amazing land,  but because she's a genuinely great person, ethical, generous and extremely effective.
While a land search led us to Seldovia, a real gift came to us through the relationship formed with Jenny.
She is incredibly family and community oriented, with exceptional knowledge of the area, the process of buying or selling, and her time with us from the moment we stepped off the plane was second to none.
Our experience with Jenny was top of the line, and if we ever make a recommendation, or find ourselves in the market again in Seldovia, Jenny Chissus will 100% be our realtor above all.
She's more than welcome at our home anytime because she’s just that great!`},
 {name:"Ariel M.",role:"",c:"#2d6a4f",t:`Jenny took great care of us and walked us through the process when buying and selling. She is great at her job, knows the area, and knows how to help make the process as easy and simple as possible for her clients. I highly recommend her!`},
 {name:"Ashley K.",role:"",c:"#8a5a2b",t:`Using Jenny for our real estate transaction in Seldovia was the best decision we could have made! We are so lucky to have her now as our neighbor, as that is the way she treated us during the purchase of our new home. The transaction was done remotely, and she went above and beyond to make sure that all deadlines and boxes were checked off! She made sure we knew all the perks of moving to an off the grid remote Alaska community and helped us get welcomed with open arms. We recommend anyone looking to move to Seldovia or the surrounding areas to reach out to Jenny.`},
 {name:"Barb B.",role:"",c:"#1d6b78",t:`All I had to do was call Jenny and leave a message..." Jenny, can you ask him if he'll take 10,000 down, owner finance?" In 8 hours the contract was signed and 30 days later, I owned the sweetest cabin overlooking the bay and I wasn't even in Seldovia. Jenny is kind, in touch with your needs. I was so pleased and impressed with Jenny's ability to. take matters by the reins immediately and go for the gusto!!!!!!! Thank you Jenny.`},
 {name:"Biff & Louise F.",role:"",c:"#663015",t:`In August of 2018 we needed a realtor. Due to our circumstances we didn't have time to waste on one that wasn't exceptional. We needed to sell our remote cabin and with the best results possible, as quick as possible. Jenny Chissus was referred to us through my daughter's Century 21 office in Wasilla. We set up a time to meet her at the cabin, and her punctuality, friendliness, professionalism, and extreme care for our family under a tough situation was immediately evident. My dad liked and respected her right away (not a easy thing to do) so there was no need to look any further. From the first day when we signed for her to list it, until the day it closed and we closed that door, Jenny wasn't just our realtor, she had became our rock out in a remote place where we just couldn't be and couldn't spend time wondering if our father was being treated with the respect he deserved. He was in very good hands. Dad selling his cabin was the toughest and saddest thing he'd done in a very long time, it had been in his family for as long as anyone of our memories go. She took the reigns and handled it with such extreme care that it took just enough of the pressure off of us. Jenny went on to send dad, and my husband and I a special care package and even after the cabin closed and our contract was complete she would still check on our family. Our dad passed in mid December. Right up near the top of the list of people I contacted was her. I knew she cared, and I knew she wanted to know. We won't be going back to Seldovia or MacDonald's Spit, more than once or twice more, but if I knew of anyone or needed her services myself there would be no hesitation who I would call.`},
 {name:"Blitch S.",role:"",c:"#3a5a8a",t:`Simply an exceptional individual to work with. She is very responsive and communicates very well. She made things simple and transactions easy. She's the go-to person to make things happen. Thanks Jenny!`},
 {name:"Bob B.",role:"",c:"#b0447e",t:`Jenny recently helped sell my home in Seldovia. I could not say enough good things about how easy she made the process. She had an offer in I say four days, she says 12 days. She answered every phone call and stupid question I asked. Jenny dealt with all the paper work and utilities and other agencies all I had to do was sign. Thank you Jenny for your hard work and your kindness.`},
 {name:"Brian & Laura C.",role:"",c:"#2d6a4f",t:`Jenny Chissus, Broker/Realtor and owner of Seldovia Property in Seldovia, Alaska, assisted my family with our search for vacant land that would be perfectly suited to build a cabin on. Jenny spent hours of her day making sure we were able to visit and physically see the many different properties on the market that we were interested in (both in Seldovia and further out on Jakolof Bay Road). We finally decided on a beautiful piece of land to purchase, and have since built an amazing little cabin together as a family. As lifelong Alaskans, I am happy to finally say that Jenny Chissus has helped us realize our remote Alaskan dream. Our family cannot thank her enough for her knowledge and expertise in real estate, and of course her upbeat kind personality to top it all off! We would highly recommend Jenny for all your Seldovia property needs!`},
 {name:"Brie C.",role:"",c:"#8a5a2b",t:`We bought our 1st home in seldovia in the middle of a snow storm last year. Jenny went out of her way to make sure we had everything we needed for the bank and the sellers needs! It was an amazing experience knowing how knowledgeable she was not only with Seldovia but with the property itself! Thank you Jenny!`},
 {name:"Chance & Ecola C.",role:"",c:"#1d6b78",t:`My husband and I have had the pleasure of working with Jenny on several occasions. Initially we were in the market to purchase a house/property for our growing family, but wanted to find just the right fit.
Jenny tirelessly showed us property after property around Seldovia until we finally found one we thought would work. Unfortunately (or fortunately) after several months of going back and forth (and I’m sure a lot of paperwork on Jenny’s part), we decided to walk away from that purchase. But Jenny was not dismayed, and had another (much better) property lined up to show us, which we ended up purchasing.
My husband and I appreciate Jenny and all of the hard work she put into helping us find our home. She was always quick to respond and helped walk us through each and every step along the way. Jenny is extremely knowledgeable, and if she didn’t have an answer to one of my many questions, she worked at finding the answer and always let me know the status of the inquiry. I couldn’t be more pleased with the final outcome and would not hesitate to work with Jenny again.`},
 {name:"Chris & Karen",role:"",c:"#663015",t:`I want to thank Jenny from the bottom of our hearts. We had a realtor prior for a year and we had no bookings or showing except shown by another realtor. I chose a realtor that wasn't local. When my contract ended, I  asked her if she would be my realtor. She said yes she would. After she took over on August 31 the First day she showed our home and within 5 days we had an offer and by day 6 under contract and closed in 35 days. Always choose a local realtor they know the area. Thank you so much`},
 {name:"Christine D.",role:"",c:"#3a5a8a",t:`We very much appreciated Jenny’s professionalism and helpfulness in the purchase of our home.  Even with a small budget it was a big decision for us and Jenny was just as excited as we were!  She made our dream possible!!! Thank you Jenny.`},
 {name:"David F.",role:"",c:"#b0447e",t:`Over the last three years Jenny has helped me buy two Seldovia Properties which I needed to, and was able to, purchase sight unseen due to her amazing work.  Her pictures and plat pics are great, and her understanding of the area is innate.  She (and her husband Sonny) have gone above and beyond over and over (to hold shipped boxes till after closing and then drop them off, to hold keys, etc...). In short, I consider Jenny a friend as much or more than a real estate agent, and I honestly don't think you could have a better experience than working with her.  I am sooooo happy with the places I have purchased and her help in so many regards.  If there were more stars, she would get them all.`},
 {name:"Doug & Kris M.",role:"",c:"#2d6a4f",t:`Jenny was with us & on top of everything through the whole selling experience. She made creative marketing suggestions like putting in a trail to our creek, that added interest to the property & raised the sales value. She knows the area & its people so well & genuinely cares for them & always made us feel like we had high value. She understands the emotional experience that the seller goes through upon leaving their home & area & its people behind & she was always sensitive to this & had the utmost compassion through everything we were experiencing. We were so lucky to have her as agent & hold her always in highest esteem as our treasured friend. Best wishes,`},
 {name:"Fern S.",role:"",c:"#8a5a2b",t:`Jenny lives in Seldovia, so she really knows the area. She is knowledgeable and a very pleasant person.  If you need real estate in Seldovia, she should be your choice!`},
 {name:"Frank F.",role:"",c:"#1d6b78",t:`Jenny is a great person who knows and loves Seldovia. She sold a house for us several years ago, and in the process became a wonderful friend. If you’re thinking about buying a piece of paradise called Seldovia, then Jenny is the person to work with.`},
 {name:"Frank T.",role:"",c:"#663015",t:`We called Jenny out of the blue as we saw a property online we liked in Seldovia..She could not have been more helpful.  We were able to buy the house at a good price and that was only the start.  She and her husband have helped us numerous times with non related issues.  Her friendship is the gift that keeps on giving.`},
 {name:"Jennafer M.",role:"",c:"#3a5a8a",t:`Great experience, Jenny was very helpful and we would highly recommend her`},
 {name:"Jennifer M.",role:"",c:"#b0447e",t:`My husband and I had been looking at properties for several years in Seldovia before finding the perfect spot last year. Each time we visited Seldovia, Jenny would show us everything that was available. She and her husband even took us across the bay in their boat to look at a place that was for sale. Invariably we couldn't find anything that my husband and I could both agree on. If I liked a place, he wouldn't like it, or if he liked a place, I wouldn't like it. Jenny was very patient with us. Last year some property became available that we both fell in love with just by viewing the pictures that Jenny had posted online. However, we were unable to make it to Seldovia to actually see the property in person. After several phone calls to Jenny and lots of questions answered by her, and also because we were somewhat familiar with the area from our previous visits, we bought the property, sight unseen. Jenny was open and honest with us about the property, and we trusted her to not lead us astray. We finally made it back to Seldovia earlier this month (a year after our purchase) to see the property, and we were not disappointed in any way. Jenny was true to her word. The property was exactly how she said it would be, and we couldn't be more happier with it. Thank you Jenny! We can't wait to spend lots more time there!`},
 {name:"Jim & Amber M.",role:"",c:"#2d6a4f",t:`We have worked with Jenny several times and in 2006 as she helped us buy an unfinished house and the 1/4 acre lot next door. She is a warm and inviting person who is a long time resident of Seldovia. She is passionate about the community and the future of this picturesque seaside town. Jenny was supportive throughout the entire real estate process and we would definitely use her as our agent again.`},
 {name:"John & Diane K.",role:"",c:"#8a5a2b",t:`Our family recently moved to Seldovia AK from three states in the lower 48. Jenny worked tirelessly for our family (over a year) always with our family’s best interest in mind. She is truly like no other agent on the Kenai Peninsula.  She continues to make us smile everyday! Eight months later we still have to pinch ourselves because we can’t believe our good fortune to be in Seldovia Alaska!!!`},
 {name:"John & Diane R.",role:"",c:"#1d6b78",t:`We had a great experience working with Jenny to purchase a remote cabin in Kachemak Bay. She has an in-depth knowledge of the area and had prompt answers for all our questions. She assisted us in getting to the property and took time to show us additional properties as well. She was quick and efficient in submitting our offer and professionally guided us through the negotiations and closing process. Following a windstorm prior to closing, she personally checked on the property to ensure there was no damage from the storm.  We highly recommend Jenny Chissus for your real estate needs.`},
 {name:"John & Dianne G.",role:"",c:"#663015",t:`We had the pleasure of working with Jenny when our family sold a very dear property that had belonged in the family for decades and bespoke many beginnings and journey's that involved generation's.  Jenny always showed caring and respect for the undertaking of the sale and we felt absolute confidence that it mattered as much to her as it did ourselves.  It should also be said that selling properties in Seldovia isn't just a business to Jenny, Seldovia is her home and she takes each client's goals to heart.`},
 {name:"John & Yvette Delaquito",role:"",c:"#3a5a8a",t:`We were referred to Jenny by a friend to sell a piece of property in Seldovia. She took the time to familiarize her self with the property to include walking the piece and taking pictures which was a challenge due to the fact it was not right on the road system. She was able to market and sell the piece of property quickly.
She is very polite, professional, and knowledgeable of the area, and we were able to complete the transaction without any issues. And we would highly recommend her for property in the Kachemak bay area.`},
 {name:"Josh & Cathy F.",role:"",c:"#b0447e",t:`Jenny Chissus was our first pick when we decided to purchase property in Seldovia, AK. She responded to our initial property search via email with an immediate phone call! She is easy to talk to and incredibly knowledgeable of the area. When we traveled to Seldovia she met us for lunch and became an instant friend. She drove us from property to property and never made us feel rushed or pressured. Jenny knows this area inside and out. There is no way you can purchase a property here without Jenny's local insight and knowledge. We had many discussions about buying a home "in-town" versus "out the road"--she never tried to sway us either way; she truly wanted us to pick whatever would be best for our family and make our move here successful.
...
Our move to Seldovia, AK was a huge undertaking and who should greet us upon arrival but Jenny Chissus! She welcomed us to our new home and even took us out for a pizza party that night. She is more than a realtor--she has become a dear friend and is incredibly supportive of people living their dreams, whatever that may be. Thanks Jenny`},
 {name:"Karl M.",role:"",c:"#2d6a4f",t:`Jenny, you did a great job. Thank you very much. You are very professional and very honest. My property sold quickly! Five stars! Jenny is a long-time Seldovian who knows the community and gives great service.`},
 {name:"Kristine B.",role:"",c:"#8a5a2b",t:`Jenny was a delight to work with when I was selling my property in Seldovia. Her responses were timely when I had questions. I knew what to anticipate in the closing process as she guided me through. Thank you again Jenny!`},
 {name:"Lauren M.",role:"",c:"#1d6b78",t:`Jenny is phenomenal! Her kindness, knowledge and professionalism made our house buying process easy and enjoyable. I would highly recommend her to anyone looking to sell or buy a home in Seldovia.`},
 {name:"Layla J.",role:"",c:"#663015",t:`Jenny is amazing and goes above and beyond`},
 {name:"Liane C.",role:"",c:"#3a5a8a",t:`I can honestly say Jenny went above and beyond. I’ve worked with her on two of my homes. Her knowledge, helpfulness, and above all - caring! A+ - thank you so very much, Jenny.`},
 {name:"Mariah T.",role:"",c:"#b0447e",t:`Jenny was so responsive working remotely through our negotiations with the seller; while she was on vacation! We wern't familiar with the process of buying a house and feel that jenny keeping us on track. It was our pleasure having her guide us through the process. She saved us alot of time. She's professional, efficient and personable!`},
 {name:"Melody H.",role:"",c:"#2d6a4f",t:`Jenny was so helpful when my family decided to make Seldovia our home! She found us the perfect property and helped prepare me for what living in Seldovia full time would look like for our large family! She has been incredible all along the way!`},
 {name:"Noreen C.",role:"",c:"#8a5a2b",t:`It has been great working with Jenny. If she doesn't have the answer she will find it. She goes out of her way to make it smooth for you.  I would recommend her to anybody looking to buy or sell. Several of my family members have used her. All agree that she is great to work with.  I would like to add that not only are you getting a knowledgeable agent, you are getting a friend who genuinely wants the best for you.`},
 {name:"Patricia H.",role:"",c:"#1d6b78",t:`Looking for a real estate agent? Please allow me to heartily recommend Jenny Chissus of Seldovia Property. This past year Jenny helped us with multiple transactions, all of which proceeded smoothly. Due to Jenny's professionalism and honesty, we were comfortable enough to purchase two properties unseen. Once we arrived in Alaska, and we actually got to see our purchase, we were totally satisfied. Jenny went above and beyond in assisting us and she makes sure her clients are satisfied. She was a pleasure to work with and displays an awesome sense of humor. We not only have a terrific real estate agent but my husband and I feel we have made a new friend.`},
 {name:"Patrick P.",role:"",c:"#663015",t:`Jenny is awesome.

Jenny helped facilitate my wife and I’s purchase of land in Seldovia this summer. We were really excited about one piece of land and it sold before we even get a chance to look come down and look at it. Jenny (going well above and beyond) found us another similar listing that was in our price range and did some serious work to connect the dots to make it happen. Not only that, she is extremely honest and transparent about everything and given that we’re new to this process it made us feel very comfortable.

She’s super knowledgeable, conscientious, and really looked out for us. She’s actively engaged with the community too and knows all the people you should coordinate with to get things done. Which is really helpful when you’re trying to bootstrap a cabin from scratch. She cares.

If you’re going to buy property in Seldovia or the surrounding area, go through Jenny. The land my wife and I are buying for our family was not very costly in real estate terms. Even so, Jenny knew that for us it was important and a big expense; she treated us the same as if we were going to buy an extremely expensive property. That’s pretty cool and we would be lost without her help.

So, I guess stop reading Google reviews on realtors and go give her a call if you want to buy land in Seldovia. What are you waiting for?`},
 {name:"Paul & Lori",role:"",c:"#3a5a8a",t:`We had an outstanding experience working with Jenny Chissus of Seldovia Property during our recent purchase in Seldovia, Alaska. Jenny’s communication was excellent every step of the way—she kept us informed, answered all of our questions promptly, and made sure we understood every detail of the process.

The transaction was incredibly transparent, and Jenny’s professionalism and integrity gave us complete confidence in our decision. She was also extremely helpful and flexible, going above and beyond to accommodate our needs and make the entire process smooth and stress-free.

If you’re looking for a reliable, knowledgeable, and dedicated realtor in Seldovia, we can’t recommend Jenny highly enough. Thank you, Jenny, for helping us find our dream “shop!”`},
 {name:"Paulie C.",role:"",c:"#b0447e",t:`Jenny is a full-service Broker. Several years ago she found the right Buyer for our remote cabin and just this year she was instrumental in helping us sell our Seldovia property and business. She is very professional and knowledgeable and still makes you feel “cared for” all along the way. Whether it’s commercial or residential – buying or selling -- Jenny should be your first call!`},
 {name:"Radzy R.",role:"",c:"#2d6a4f",t:`In 2011, I was shopping for Real Estate in Jenny's general area, and I ended up buying property that she had listed. She was not my agent, but I was very impressed with the level of service she provided. I previously lived in the lower 48, and it was a significant trip to come looking for property. When I came to the Seldovia area, Jenny made time to visit a property, along with me and my agent. During that time, she showed me a little bit of the town and pointed out some of the things that I would need to know if I decided to buy. I didn't end up buying that property, for reasons that have nothing to do with Jenny and the services she provides. Instead, after I had returned to the lower 48, I found a listing for a home in town, which Jenny had listed, and bought that place. When I arrived after a 10-day drive up the Alaska highway, Jenny helped me get settled in. She introduced me to some of the people that I need to know, and showed me around town again. Great service from a real estate agent who wasn't even my agent!  I was extremely happy with the level of service that Jenny provided during the sale, and I continue to be happy to see the effort she makes for people who move into the area. Truly an exceptional real estate professional.`},
 {name:"Rand G.",role:"",c:"#8a5a2b",t:`Without Jenny's professional assistance, I am sure we could not have executed the sale of this property on our own.  The sale involved three owners all living outside of Seldovia.  Jenny went above and beyond the call of duty to help with the details, coordinating the administration and  ensuring a successful closing. She knows the Seldovia area well and she knows how to find the buyers.  I highly recommend anyone buying or selling property in the Seldovia region to contact Jenny first.  You will be glad you did and you will find her services to be essential to achieving your goal.`},
 {name:"Randi S.",role:"",c:"#1d6b78",t:`I had the pleasure of working with Jenny when I was looking to buy a home in Seldovia.  She immediately made me feel welcome in Seldovia and helped me find my home.  Jenny helped me through the process and has become a dear friend.`},
 {name:"Rich K.",role:"",c:"#663015",t:`This was so easy for me. Jenny did all kinds of work, I did almost nothing. She snowshoed the property, took pictures, went with the surveyor, took more pictures after the snowmelt. I'm thousands of miles away,never lifted a finger. She's smart and clear,very relaxing to talk to; we shared some fun stories. We never met in person, but she's making me miss Seldovia.`},
 {name:"Rocky & Toni",role:"",c:"#3a5a8a",t:`I have worked with Jenny and her clients many times over the years, and she is always a joy to work with. She is very professional and strives to communicate well with all parties involved.`},
 {name:"Ron H.",role:"",c:"#b0447e",t:`If you are contemplating real estate in the Seldovia area I can heartily recommend Seldovia Property.  Jenny Chissus recently assisted me in the purchase of a plot of land on which I intend to build.  This was somewhat difficult since I live in Florida.  Jenny found a piece of land that perfectly suited my needs and did all the paperwork for a seamless and painless purchase,  this was done sight unseen by me.  Jenny was a delight to work with and would,  without hesitation use her services again.`},
 {name:"Ryan O.",role:"",c:"#2d6a4f",t:`We recently purchased and sold a property in Seldovia with Jenny. She was courteous, professional, and responsive. We would highly recommend Jenny to anybody looking to purchase or sell real estate in Seldovia. She truly knows the market and offers great service. We found not only a great real estate professional but a wonderful friend moving forward. We will be back to continue on with our Seldovia dream with Jenny in the near future.`},
 {name:"Sandy B.",role:"",c:"#8a5a2b",t:`Jen Is the best real estate agent we have ever worked with in 35 years. She really goes the extra mile and is extremely competent at her job.`},
 {name:"Sean C.",role:"",c:"#1d6b78",t:`Jenny is the best agent I have worked with in either Alaska or California. As a long time native of Seldovia, she has an intimate knowledge of the market, available properties and has built a very strong network of contractors and contacts to help manage a property once you become an owner. Seldovia is a unique market and her knowledge/relationships are invaluable. Her office is among the first buildings you’ll see when you get off the ferry. You would be remiss to not stop by and say hello for a warm Seldovian welcome and quick orientation to the area.  I would recommend Jenny to any family or friend interested in buying the area.`},
 {name:"Shelly",role:"",c:"#663015",t:`Jenny helped me make my dream a reality! She listened, we discussed options, zoning, permits and am very pleased with our offer being accepted! Yes, I highly recommend Jenny for your professionalism, promptness, attention to detail with her desire to help. Thank you!`},
 {name:"Shirley H.",role:"",c:"#3a5a8a",t:`Jenny helped us find our new home in Seldovia in 2006 and sold it after my husband's passing in 2015. She has the local knowledge and experience to get your home listed or if you are looking to purchase.`},
 {name:"Steve C.",role:"",c:"#b0447e",t:`My wife and I bought a piece of property in Seldovia from Jenny in 2012 and five years later I still think of her name first and call her as the gal that knows everything about Seldovia. I called her as recently as today. She's a highly capable RE Agent and supremely helpful. If you're thinking about buying in Seldovia and you're not buying through Jenny... you're making a mistake.`},
 {name:"Steven & Vickie C.",role:"",c:"#2d6a4f",t:`When my wife and I were searching for that "perfect place" in Seldovia, Jenny did a fantastic job. She not only spent many, many hours with us showing us multiple possible properties, but when we did find the place we fell in love with, she worked closely with us over the next umpteen months (not easy, since we live in Fairbanks, and she had to be our eyes and ears on site in Seldovia). We had several important items to be addressed before we felt comfortable making a firm offer on the place, and Jenny was an absolute rock-star on resolving every question/issue, including working with the Owner (out-of-State), bringing Contractors on site to confirm the Well / Electricity were fully functioning, no hidden problems, etc... She was fantastic through all of this, although I'm sure we tried her patience (LOL). 5 Stars to Jenny !!`},
 {name:"Steven C.",role:"",c:"#8a5a2b",t:`Just wanted to say that Jenny did an AMAZING job for us, helping us find the perfect Cabin property in Seldovia.  We have truly found our "Happy Place," and could not have done it without her Realtor expertise and help. From the start, and all the way through the process, Jenny got us through every step with ease.  Way to go, Jenny !!`},
 {name:"Tara S.",role:"",c:"#1d6b78",t:`Jenny was fantastic to work with. I appreciated her professionalism and kindness in helping us navigate our real estate needs and see to a successful outcome.`},
 {name:"Terri J.",role:"",c:"#663015",t:`Very friendly and knowledgeable about the area!`},
 {name:"Todd B.",role:"",c:"#3a5a8a",t:`Jenny has an amazing amount of knowledge about the area that I was looking for a home. She was quick to respond with any questions that I had, and effortlessly guided me through the buying process. Jenny's patience and expertise helps make the entire process of searching for and buying a home a breeze! I would definitely recommend Jenny!`},
 {name:"Tyler & Cheri C.",role:"",c:"#b0447e",t:`Jenny helped us get our perfect cabin. She is the most knowledgeable and helpful realtor. There isn't anything that she doesn't do for you, she is the whole package. We are very happy with her services and would go to her again and again. She knows Seldovia and its people perfectly.`},
 {name:"Zillow review",role:"",c:"#2d6a4f",t:`My husband and I have been visiting Seldovia since 2003. I instantly fell in love with the community and country-side. We started to seriously think about buying land or a home in 2004. Jenny was able to correspond with us via telephone and email. We do not live in Seldovia at the moment, but wanted a summer home and later would be our retirement home. We did buy an exiting home in Seldovia, but prior to this purchase, Jenny took us to many pieces of property and already built homes before we settled on the one we liked. Jenny is personable and still someone we can turn to about questions we might have about the town. She keeps the community well informed through our local e-newspaper! I have to give her an A+ for a great job and I love her new PINK Real Estate signs!`},
 {name:"Zillow review",role:"",c:"#8a5a2b",t:`Jenny was the easiest realtor to work with! I saw a home I was interested in and did not have cell phone service in Seldovia. I walked to her office and asked her to show me the property. She dropped what she was doing and came to my assistance right away. When I decided to purchase, she guided me with inspections, paperwork, etc. She took me by the hand and made the journey pleasurable. I would highly recommend Jenny if you are wanting to sell or purchase property in Seldovia. She does know the area and is very personable. She is not a "pushy salesman" by any means! I have been very happy with my decision to purchase in Seldovia and I am glad that Jenny was part of that process :-)`},
 {name:"Zillow review",role:"",c:"#1d6b78",t:`Jenny has been a pleasure to deal with through the whole buying process and goes over and above what one would expect. Her honesty and knowledge of the Real Estate business is truly impressive. She skillfully answered all of our questions and was very prompt. I highly recommend her if you are buying or selling property.`},
 {name:"Zillow review",role:"",c:"#663015",t:`Jenny sold our home for us when we no longer lived in Seldovia. It was so easy with the Docusign system she uses. She was a great communicator and helped us negotiate our way through a successful sale. She has been a friend for many years, however, we always appreciated her professional demeanor when we were doing business together.`},
 {name:"Zillow review",role:"",c:"#3a5a8a",t:`Jenny knows the area very well, and understands what it takes to sell a home in Seldovia. Jenny held our hand through the whole process which took place long distance. I really felt that Jenny understood my needs and went 1000 times out of her way to help make the sale. I wouldn’t use anyone else in Seldovia.`},
 {name:"Zillow review",role:"",c:"#b0447e",t:`She has lived in Seldovia for many years and knows all the locals and real estate market very well. It took 2 years to get the house sold because it was one of the larger and newly remodeled homes in Seldovia which put it near the top of the price range. Jenny worked on this sale continuously for the whole 2 years and did a great job! Her husband s a local contractor who also does a "Winter Watch" program to keep an eye on your home if it is vacant.`},
 {name:"Zillow review",role:"",c:"#2d6a4f",t:`Thanks to Jenny we found our dream summer home. We were so happy with how Jenny made purchasing our home so easy. We never felt pressured in any way. It was so nice to work with someone local to Seldovia. She knew and understood what we were looking for. She made time to get to know our family and our desires we looked for in a summer home. We Love you Jenny.. Thank you!`},
 {name:"A Seldovia client",role:"",c:"#8a5a2b",t:`Jenny is the ultimate authority on Seldovia property. She and her family live there full-time and Jenny is a very active member of the community. Consider Jenny first if you are interested in Seldovia real estate.`}
];
...
if($("#quoteGrid")){
  if(!TESTIMONIALS.length){ const sec=$("#quoteGrid").closest("section"); if(sec) sec.style.display="none"; }
    ...
    const cards=TESTIMONIALS.map(t=>`<div class="quote"><span class="qmark">&rdquo;</span><div class="quote-head"><span class="avatar" style="background:${t.c}">${esc(t.name[0])}</span><span><b>${esc(t.name)}</b>${t.role?`<span>${esc(t.role)}</span>`:""}</span></span></div><div class="quote-text">${paras(t.t)}</div><button type="button" class="quote-more" hidden>Read more</button><div class="quote-stars" aria-label="Five out of five stars">★★★★★</div></div>`).join("");
